...
const QUESTIONS = {
    easy: [
        { q: "Smallest unit of share capital?", o: ["Bond", "Share", "Debenture", "Deposit"], a: 1 },
        { q: "Persons who purchase shares?", o: ["Shareholders", "Creditors", "Debtors", "Suppliers"], a: 0 },
        { q: "Return on investment for shareholder?", o: ["Interest", "Rent", "Dividend", "Commission"], a: 2 },
        { q: "Example of owned capital?", o: ["Debentures", "Bonds", "Equity Shares", "Public Deposits"], a: 2 },
        { q: "Latin word 'debere' means?", o: ["To give", "To owe", "To buy", "To share"], a: 1 },
        { q: "Who are the real masters of a company?", o: ["Debenture holders", "Equity shareholders", "Preference shareholders", "Bond holders"], a: 1 },
        { q: "Fixed return on borrowed capital?", o: ["Dividend", "Interest", "Bonus", "Discount"], a: 1 },
        { q: "ADR traded in which country?", o: ["U.S.A.", "India", "Japan", "UK"], a: 0 },
        { q: "Reinvesting profit back into business?", o: ["Retained earnings", "External finance", "Trade credit", "Overdraft"], a: 0 },
        { q: "Share certificate is evidence of?", o: ["Debt", "Title", "Loan", "Credit"], a: 1 }
    ],

    medium: [
        { q: "'Ordinary Shares' are also called?", o: ["Preference", "Equity", "Deferred", "Cumulative"], a: 1 },
        { q: "Debenture holders are considered?", o: ["Owners", "Creditors", "Partners", "Directors"], a: 1 },
        { q: "Shareholders known as 'residual claimants'?", o: ["Equity shareholders", "Preference shareholders", "Debenture holders", "Bond holders"], a: 0 },
        { q: "Shares issued free to existing members?", o: ["Right shares", "Bonus shares", "Preference shares", "Deferred shares"], a: 1 },
        { q: "Pref shares with unpaid dividend carry-over?", o: ["Non-cumulative", "Cumulative", "Participating", "Redeemable"], a: 1 },
        { q: "New shares offered to existing members first?", o: ["Bonus issue", "Right issue", "Public issue", "Private placement"], a: 1 },
        { q: "Debentures convertible to equity?", o: ["Convertible", "Bearer", "Registered", "Secured"], a: 0 },
        { q: "Depository Receipts outside USA?", o: ["ADR", "GDR", "IDR", "EDR"], a: 1 },
        { q: "Withdrawing more than balance (Bank)?", o: ["Cash credit", "Overdraft", "Cash loan", "Trade credit"], a: 1 },
        { q: "Which is considered 'Risk Capital'?", o: ["Equity capital", "Preference capital", "Debenture capital", "Debt capital"], a: 0 }
    ],

    hard: [
        { q: "Inst. established in 1948 for development?", o: ["IDBI", "IFCI", "ICICI", "LIC"], a: 1 },
        { q: "Secured debentures create a ___ on assets?", o: ["Dividend", "Charge", "Debt", "Right"], a: 1 },
        { q: "'Ploughing back of profit' is ___ source?", o: ["External", "Internal", "Borrowed", "Short-term"], a: 1 },
        { q: "Power to issue debentures lies with?", o: ["Shareholders", "Board of Directors", "Auditors", "Trustees"], a: 1 },
        { q: "Equity shares with 'differential voting rights' rules?", o: ["Companies Rules 2013", "Rules 2014", "SEBI Rules", "RBI Rules"], a: 1 },
        { q: "Pref shares prohibited from being issued?", o: ["Irredeemable", "Redeemable", "Cumulative", "Convertible"], a: 0 },
        { q: "Debentures cannot carry ___ rights?", o: ["High interest", "Voting rights", "Security", "Long maturity"], a: 1 },
        { q: "Agreement between company & trustees?", o: ["Trust Deed", "Articles", "Memorandum", "Prospectus"], a: 0 }
    ]
};
