...
const QUESTIONS = {
    easy: [
        { q: "The term finance is related to money and...?", o: ["Spent", "Management", "Distribution", "Collection"], a: 1 },
        { q: "Who said 'Money is an arm or leg'?", o: ["Henry Hoagland", "Henry Ford", "J. S. Mill", "Gerstenbergh"], a: 1 },
        { q: "Choosing Equity vs Debt is?", o: ["Investment decision", "Financing decision", "Marketing decision", "Production decision"], a: 1 },
        { q: "Finding investments and deploying them?", o: ["Capital budgeting", "Capital structure", "Financial planning", "Dividend payment"], a: 0 },
        { q: "Minimum return expected by investors?", o: ["Retained earnings", "Net profit", "Cost of capital", "Working capital"], a: 2 },
        { q: "Finance mandatory for growth through?", o: ["Taxation", "Research Development", "Labor strikes", "Old assets"], a: 1 },
        { q: "Assessment of financial requirement is?", o: ["Capital structure", "Production cycle", "Financial plan", "Business cycle"], a: 2 },
        { q: "Capital used for buying fixed assets?", o: ["Working capital", "Fixed capital", "Circulating capital", "Gross capital"], a: 1 },
        { q: "Initial planning of fixed capital made by?", o: ["Creditors", "Customers", "Promoters", "Debenture holders"], a: 2 },
        { q: "Contract granting possession of property?", o: ["Lease", "Dividend", "Tax", "Loan"], a: 0 }
    ],

    medium: [
        { q: "In cyclical flow, cash converts first to?", o: ["Inventories", "Receivables", "Sales", "Production"], a: 0 },
        { q: "Trading firms need less fixed capital than?", o: ["Manufacturing industries", "Retail shops", "Service providers", "Merchandising firms"], a: 0 },
        { q: "Public utilities need less WC due to?", o: ["Credit sales", "Cash inflow", "Raw materials", "Fixed assets"], a: 1 },
        { q: "High population rate is opportunity to?", o: ["Close business", "Expand business", "Reduce capital", "Sell assets"], a: 1 },
        { q: "If sub-contracting, fixed capital req will?", o: ["Minimise", "Increase", "Double", "Stay same"], a: 0 },
        { q: "During boom, working capital req will?", o: ["Increase", "Decrease", "Disappear", "Remain constant"], a: 0 },
        { q: "Liberal credit policy creates need for?", o: ["Fixed capital", "Working capital", "Owned capital", "Preference shares"], a: 1 },
        { q: "Priority right for dividend payment?", o: ["Preference shares", "Equity shares", "Debentures", "Term loans"], a: 0 },
        { q: "Certificate of acknowledgement of loans?", o: ["Debenture", "Share", "Reserve", "Dividend"], a: 0 },
        { q: "Capital structure is basically a?", o: ["Market mix", "Security mix", "Product mix", "Service mix"], a: 1 }
    ],

    hard: [
        { q: "Debt to equity ratio geared to degree of?", o: ["Earning stability", "Market competition", "Population trend", "Consumer preference"], a: 0 },
        { q: "Objective of investors in fixed capital?", o: ["Immediate returns", "Future profit", "Liquidation", "Interest payment"], a: 1 },
        { q: "To absorb shocks, structure needs?", o: ["Debt ratio", "Equity cushion", "Loan amount", "Interest rate"], a: 1 },
        { q: "Using assets without buying reduces FC?", o: ["Sub-contracting", "Lease basis", "Concessional rates", "Old assets"], a: 1 },
        { q: "If production cycle is longer, firm needs?", o: ["Less capital", "More capital", "No capital", "Borrowed capital"], a: 1 },
        { q: "Merchandising firms carry big...?", o: ["Inventories", "Fixed assets", "Liabilities", "Term loans"], a: 0 },
        { q: "Coordination with finance ensures?", o: ["Taxes increase", "Production continues", "Risks disappear", "Debt increases"], a: 1 },
        { q: "Collection of receivables goes back to?", o: ["Cash", "Sales", "Production", "Inventory"], a: 0 }
    ]
};
