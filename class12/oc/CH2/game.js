...
const QUESTIONS = {
    easy: [
        { q: "Basic and first function of management?", o: ["Staffing", "Planning", "Controlling", "Directing"], a: 1 },
        { q: "Keyword 'POSDCORB' given by?", o: ["Henry Fayol", "F.W. Taylor", "Luther Gullick", "L.A. Allen"], a: 2 },
        { q: "'Management is what a manager does'?", o: ["L.A. Allen", "Henry Fayol", "James Stoner", "Theo Haimann"], a: 0 },
        { q: "Function: 'Right person at right job'?", o: ["Planning", "Organizing", "Staffing", "Coordinating"], a: 2 },
        { q: "Directing is known as the '___'?", o: ["Brain", "Soul", "Hand", "Goal"], a: 1 },
        { q: "Checking actual performance vs standards?", o: ["Planning", "Controlling", "Organizing", "Coordinating"], a: 1 },
        { q: "Who directs in Joint Hindu Family?", o: ["Members", "KARTA", "Partners", "Directors"], a: 1 },
        { q: "Identifying and grouping resources?", o: ["Planning", "Organizing", "Staffing", "Controlling"], a: 1 },
        { q: "Functions of a manager end with?", o: ["Directing", "Staffing", "Controlling", "Coordinating"], a: 2 },
        { q: "Planning is detailed programme of?", o: ["Past", "Present", "Future", "Optional"], a: 2 }
    ],

    medium: [
        { q: "Planning is an ___ process?", o: ["Physical", "Intellectual", "Emotional", "Occasional"], a: 1 },
        { q: "Function executing top-level plans?", o: ["Organizing", "Planning", "Controlling", "Budgeting"], a: 0 },
        { q: "Staffing manages which resource?", o: ["Financial", "Material", "Human", "Physical"], a: 2 },
        { q: "Function that 'initiates action'?", o: ["Planning", "Organizing", "Directing", "Coordinating"], a: 2 },
        { q: "Co-ordination is described as ___ force?", o: ["Visible", "Hidden", "External", "Weak"], a: 1 },
        { q: "Reporting & Budgeting summarized under?", o: ["Planning", "Controlling", "Staffing", "Directing"], a: 1 },
        { q: "Function 'Coping with Changes'?", o: ["Organizing", "Staffing", "Directing", "Controlling"], a: 2 }, // Note: Often associated with Planning/Controlling, but Directing adapts behavior. Based on options provided.
        { q: "Planning and Controlling are ___ parts?", o: ["Minor", "Major", "Separate", "Opposite"], a: 1 },
        { q: "Function creating 'Sense of Security'?", o: ["Organizing", "Planning", "Controlling", "Directing"], a: 2 }, // Controlling assures standards
        { q: "Deviation found by comparing actual with?", o: ["Future goals", "Standards", "Past results", "Competitors"], a: 1 }
    ],

    hard: [
        { q: "Org defined as 'human association' by?", o: ["Mooney and Railey", "Theo Haimann", "Koontz and O'Donnell", "Urwick and Brech"], a: 0 },
        { q: "Function considers internal & external?", o: ["Staffing", "Planning", "Directing", "Coordinating"], a: 1 },
        { q: "'To manage is to forecast...' by?", o: ["L.A. Allen", "Henry Fayol", "Luther Gullick", "Philip Kotler"], a: 1 },
        { q: "Psychological pressure as motivation?", o: ["Planning", "Staffing", "Controlling", "Directing"], a: 2 },
        { q: "Directing focus (Theo Haimann)?", o: ["Selection & Training", "Instructions & Operations", "Goals & Objectives", "Rewards & Punishments"], a: 1 },
        { q: "Area: Selection, training, compensation?", o: ["Organizing", "Staffing", "Controlling", "Directing"], a: 1 },
        { q: "'Planning bridges the gap' by?", o: ["James Stoner", "Koontz and O'Donnell", "Philip Kotler", "Dale Henning"], a: 1 },
        { q: "Essence of organizational success?", o: ["Planning", "Co-ordinating", "Staffing", "Controlling"], a: 1 },
        { q: "Step after Measurement of performance?", o: ["Standards", "Corrective action", "Comparison", "Analysis"], a: 2 },
        { q: "Directing (Earnest Dale): What & ___?", o: ["Why it is done", "In what manner", "By whom", "With what money"], a: 1 }
    ]
};
