...
const QUESTIONS = {
    easy: [
        { q: "Who published 'General Theory of Employment'?", o: ["Maurice Dobb", "Lord Keynes", "Adam Smith", "Alfred Marshall"], a: 1 },
        { q: "Year 'General Theory' was published?", o: ["1926", "1936", "1946", "1956"], a: 1 },
        { q: "What does the word 'Micro' mean?", o: ["Large", "Small", "Whole", "Million"], a: 1 },
        { q: "Defined Micro as 'microscopic study'?", o: ["Prof. Lerner", "Lord Keynes", "Maurice Dobb", "J.L. Hansen"], a: 2 },
        { q: "Reward for factor 'Land'?", o: ["Wages", "Profit", "Interest", "Rent"], a: 3 },
        { q: "Microeconomics is also known as?", o: ["Price Theory", "Income Theory", "Growth Theory", "General Theory"], a: 0 },
        { q: "Reward for factor 'Labour'?", o: ["Rent", "Wages", "Interest", "Profit"], a: 1 },
        { q: "Macroeconomics deals with study of?", o: ["Individual units", "Aggregates", "Single firms", "Particular prices"], a: 1 },
        { q: "Macroeconomics is also known as?", o: ["Price Theory", "Income Theory", "Value Theory", "Product Theory"], a: 1 },
        { q: "Method adopted in Micro analysis?", o: ["Lumping method", "Slicing method", "Inclusive method", "Aggregative method"], a: 1 }
    ],

    medium: [
        { q: "Which is part of Scope of Micro?", o: ["Theory of Welfare", "Theory of Inflation", "Theory of Growth", "National Income"], a: 0 },
        { q: "Which is NOT a feature of Micro?", o: ["Slicing method", "Study of Aggregates", "Partial equilibrium", "Price theory"], a: 1 },
        { q: "Product pricing is determined by?", o: ["Government policy", "Demand and Supply", "National Income", "Total Investment"], a: 1 },
        { q: "Meaning of 'Marginal' in analysis?", o: ["Total units", "Average unit", "Additional unit", "First unit"], a: 2 },
        { q: "Theory of Business Cycles is part of?", o: ["Income & Employment", "Product pricing", "Factor pricing", "Economic welfare"], a: 0 },
        { q: "'General Price Level' is subject of?", o: ["Microeconomics", "Macroeconomics", "Price Theory", "Individual behavior"], a: 1 },
        { q: "In 'Free Market', decisions taken at?", o: ["Government level", "Individual levels", "Global level", "Fixed levels"], a: 1 },
        { q: "Efficiency: Max goods from...?", o: ["Infinite resources", "Given resources", "Foreign resources", "Future resources"], a: 1 },
        { q: "National Income estimates measure?", o: ["Individual profit", "Economy's performance", "Market structure", "Factor rewards"], a: 1 },
        { q: "Study of 'forest' instead of 'trees'?", o: ["Microeconomics", "Macroeconomics", "Price theory", "Slicing method"], a: 1 }
    ],

    hard: [
        { q: "Partial equilibrium studies unit...?", o: ["Jointly", "Independently", "Dependent", "Globally"], a: 1 },
        { q: "Key tool of Microeconomic analysis?", o: ["Marginalism", "Aggregation", "Lumping", "General equilibrium"], a: 0 },
        { q: "Macro takes into account interdependence of?", o: ["Aggregate variables", "Two individuals", "One firm", "One commodity"], a: 0 },
        { q: "Micro scope limited because it excludes?", o: ["Individual prices", "Nationwide problems", "Factor rewards", "Market structures"], a: 1 },
        { q: "General Equilibrium deals with?", o: ["Large aggregates", "Individual consumers", "Single industries", "Particular prices"], a: 0 },
        { q: "Economic efficiency means goods are?", o: ["Cheapest", "Most desired", "Most expensive", "Exported"], a: 1 },
        { q: "Method that hides 'individual tree' properties?", o: ["Slicing method", "Lumping method", "Partial equilibrium", "Marginalism"], a: 1 },
        { q: "Micro is Price Theory because it finds?", o: ["Factor/Product prices", "National income", "Inflation rates", "Employment levels"], a: 0 }
    ]
};
