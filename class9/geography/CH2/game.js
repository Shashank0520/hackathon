...
const QUESTIONS = {
    easy: [
        { q: "Magnitude of Nepal earthquake in news?", o: ["6.6", "7.9", "5.0", "9.1"], a: 1 },
        { q: "Internal Earth movements are called?", o: ["Exogenetic", "Atmospheric", "Endogenetic", "Surface"], a: 2 },
        { q: "Layer where internal movements occur?", o: ["Crust", "Core", "Upper Mantle", "Atmosphere"], a: 2 },
        { q: "What creates energy in the mantle?", o: ["Solar energy", "Radioactive materials", "Wind power", "Water pressure"], a: 1 },
        { q: "Instrument to record earthquakes?", o: ["Barometer", "Seismograph", "Thermometer", "Anemometer"], a: 1 },
        { q: "Point on surface above focus?", o: ["Hypocenter", "Epicenter", "Fault line", "Crater"], a: 1 },
        { q: "Himalayas are which type?", o: ["Fold mountain", "Block mountain", "Volcanic mountain", "Residual mountain"], a: 0 },
        { q: "Molten rock inside Earth is?", o: ["Lava", "Magma", "Ash", "Steam"], a: 1 },
        { q: "Scale for earthquake magnitude?", o: ["Celsius", "Decibel", "Richter Scale", "Kelvin"], a: 2 },
        { q: "India's only active volcano?", o: ["Mt. Fuji", "Barren Island", "Mt. Kilimanjaro", "Mt. Etna"], a: 1 }
    ],

    medium: [
        { q: "Movements towards each other create?", o: ["Tension", "Compression", "Fractures", "Fissures"], a: 1 },
        { q: "Continent-building movements called?", o: ["Orogenic", "Epeirogenic", "Seismic", "Volcanic"], a: 1 },
        { q: "Rift Valley example in India?", o: ["Narmada Valley", "Ganga Valley", "Indus Valley", "Brahmaputra Valley"], a: 0 },
        { q: "Why S-waves more destructive?", o: ["Faster", "Up-down movement", "Travel in liquids", "Reach surface first"], a: 1 },
        { q: "Meghalaya Plateau is?", o: ["Fold mountain", "Block mountain", "Rift valley", "Volcano"], a: 1 },
        { q: "Waves travelling through all states?", o: ["Primary waves", "Secondary waves", "Surface waves", "L-waves"], a: 0 },
        { q: "Tension in crust leads to?", o: ["Folds", "Faults", "Cones", "Peaks"], a: 1 },
        { q: "Energy waves moving apart create?", o: ["Compression", "Tension", "Folding", "Subduction"], a: 1 },
        { q: "Volcano erupting through long crack?", o: ["Conical type", "Fissure type", "Central type", "Dormant type"], a: 1 },
        { q: "Mt. Kilimanjaro is classified as?", o: ["Active", "Dormant", "Extinct", "Fissure"], a: 2 }
    ],

    hard: [
        { q: "Determines plate movement direction?", o: ["Surface wind", "Internal energy", "Moon's gravity", "Ocean currents"], a: 1 },
        { q: "Why buildings move back and forth?", o: ["P-waves", "S-waves", "Gravity", "Air pressure"], a: 0 },
        { q: "Waves generated after P & S reach surface?", o: ["Primary waves", "Secondary waves", "Surface waves", "Body waves"], a: 2 },
        { q: "Plate sliding under another is?", o: ["Constructive", "Plate consuming", "Creating", "Divergent"], a: 1 },
        { q: "Volcano type forming Deccan Plateau?", o: ["Central-type", "Fissure-type", "Conical-type", "Extinct-type"], a: 1 },
        { q: "Orogenic movements primarily build?", o: ["Mountains", "Continents", "Oceans", "Climate"], a: 0 },
        { q: "Medium where S-waves get absorbed?", o: ["Solid", "Liquid", "Gas", "Vacuum"], a: 1 },
        { q: "Relation: Epicenter and Focus?", o: ["Perpendicular", "Parallel", "45-degree angle", "Horizontal"], a: 0 }
    ]
};
