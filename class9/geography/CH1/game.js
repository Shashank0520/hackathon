...
const QUESTIONS = {
    easy: [
        { q: "Maps showing distribution of variables?", o: ["Physical Maps", "Thematic Maps", "Political Maps", "Linear Maps"], a: 1 },
        { q: "Method for counting-based data?", o: ["Isopleth method", "Choropleth method", "Dot method", "Tint method"], a: 2 },
        { q: "Symbol for urban population in Dot map?", o: ["Dots", "Squares", "Circles", "Triangles"], a: 2 },
        { q: "Darker shades in Choropleth mean?", o: ["Decreases", "Increases", "Stays same", "Disappears"], a: 1 },
        { q: "Method for continuous variables?", o: ["Dot method", "Isopleth method", "Sketch method", "Symbol method"], a: 1 },
        { q: "Lines joining places of equal value?", o: ["Isolines", "Axis", "Graticules", "Latitudes"], a: 0 },
        { q: "Variable shown using Isopleth?", o: ["Cattle count", "Temperature", "Wheat production", "Human population"], a: 1 },
        { q: "What must be uniform in a Dot map?", o: ["Color", "Dot size", "Paper size", "Map boundary"], a: 1 },
        { q: "Classes used in Choropleth map?", o: ["1–2", "10–15", "5–7", "20–25"], a: 2 },
        { q: "Field-visit is crucial for which subject?", o: ["History", "Geography", "Mathematics", "Languages"], a: 1 }
    ],

    medium: [
        { q: "Factor considered for placing dots?", o: ["Physiography", "State names", "Colors of buildings", "Local language"], a: 0 },
        { q: "Single unit representation in Choropleth?", o: ["Many dots", "Multiple lines", "One value", "Different shades"], a: 2 },
        { q: "Isolines close to each other indicate?", o: ["Gentle change", "Steep change", "No change", "Equal values"], a: 1 },
        { q: "Data used for Isopleth maps?", o: ["Counted data", "Point-related data", "Random data", "Line data"], a: 1 },
        { q: "Method to show Altitude distribution?", o: ["Dot method", "Choropleth method", "Isopleth method", "Circle method"], a: 2 },
        { q: "Purpose of 'class interval'?", o: ["Name regions", "Group data", "Scale the map", "Count people"], a: 1 },
        { q: "Values used to decide dot size?", o: ["Mean and Median", "Lowest and Highest", "Total and Average", "First and Last"], a: 1 },
        { q: "Dot method is for variables that are?", o: ["Follow borders", "Counted / Scattered", "Continuous", "Colored"], a: 1 },
        { q: "Primary use of a field-report?", o: ["Get marks", "Summarize info", "Draw new maps", "Find directions"], a: 1 },
        { q: "Method using tints of same color?", o: ["Isopleth method", "Choropleth method", "Dot method", "Physical method"], a: 1 }
    ],

    hard: [
        { q: "Why Isopleth NOT for population?", o: ["Data unavailable", "It isn't continuous", "Too hard", "Borders are small"], a: 1 },
        { q: "Dot value is determined based on?", o: ["Administrative rank", "Variable density", "Map color", "Page length"], a: 1 },
        { q: "Correct sequence for report-writing?", o: ["Conclusion, Intro, Climate", "Intro, Physiography, Conclusion", "Maps, Conclusion, Intro", "Climate, Intro, Maps"], a: 1 },
        { q: "Why use point-related data in Isopleth?", o: ["Data is counted", "Belongs to places", "Shows boundaries", "Uses circles"], a: 1 },
        { q: "Why Isopleth for rainfall?", o: ["It is counted", "It is continuous", "It is localized", "Uses dots"], a: 1 },
        { q: "Essential precaution during field-visit?", o: ["Carrying camera", "Not throwing trash", "Taking notes", "Asking questions"], a: 1 },
        { q: "What is a 'sub-administrative unit'?", o: ["Whole country", "Taluka or District", "Single house", "Mountain range"], a: 1 },
        { q: "Map showing 'natural trend' of data?", o: ["Choropleth method", "Isopleth method", "Tints method", "Pattern method"], a: 1 }
    ]
};
