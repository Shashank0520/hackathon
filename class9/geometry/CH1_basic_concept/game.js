...
const QUESTIONS = {
    easy: [
        { q: "Greek word 'Geo' means?", o: ["Measuring", "Earth", "Circle", "Space"], a: 1 },
        { q: "First Greek mathematician mentioned?", o: ["Euclid", "Pythagoras", "Thales", "Aryabhat"], a: 2 },
        { q: "Undefined term in Geometry?", o: ["Segment", "Ray", "Point", "Angle"], a: 2 },
        { q: "Distance between distinct points is?", o: ["Negative", "Zero", "Positive", "Infinite"], a: 2 },
        { q: "Distance if points are NOT distinct?", o: ["One", "Zero", "Infinite", "Negative one"], a: 1 },
        { q: "How many midpoints does a segment have?", o: ["Two", "Many", "None", "Only one"], a: 3 },
        { q: "Starting point of Ray AB?", o: ["Point B", "Point A", "Any point", "Middle point"], a: 1 },
        { q: "Logically proved properties are?", o: ["Postulates", "Theorems", "Axioms", "Definitions"], a: 1 },
        { q: "'If... then...' statement is called?", o: ["Direct", "Converse", "Conditional", "Simple"], a: 2 },
        { q: "Part following 'If' is called?", o: ["Consequent", "Proof", "Antecedent", "Postulate"], a: 2 }
    ],

    medium: [
        { q: "Coord A=-5, B=-3. Find d(A, B)?", o: ["-8", "-2", "2", "8"], a: 2 },
        { q: "d(P,Q) + d(Q,R) = d(P,R). Middle point?", o: ["Point P", "Point Q", "Point R", "No point"], a: 1 },
        { q: "If AB &cong; CD then CD &cong; AB is?", o: ["Reflexivity", "Symmetry", "Transitivity", "Perpendicularity"], a: 1 },
        { q: "Points in intersection of 2 lines?", o: ["Infinite", "Two", "One", "None"], a: 2 },
        { q: "M is midpoint of AB (8). Find AM?", o: ["8", "16", "4", "2"], a: 2 },
        { q: "Symbol: length AB less than CD?", o: ["AB &gt; CD", "AB &perp; CD", "AB &lt; CD", "AB &cong; CD"], a: 2 },
        { q: "Converse: 'If Rhombus -> Diagonals &perp;'?", o: ["If Diagonals &perp; -> Rhombus", "If not Rhombus -> not &perp;", "Diagonals are equal", "Rhombus is square"], a: 0 },
        { q: "Union of Ray AB and opposite ray?", o: ["Segment AB", "Ray BA", "Line AB", "Point A"], a: 2 },
        { q: "Lines intersecting at right angle?", o: ["Congruent", "Parallel", "Perpendicular", "Collinear"], a: 2 },
        { q: "Distance of point from a line?", o: ["Parallel segment", "Longest segment", "Perpendicular segment", "Congruent segment"], a: 2 }
    ],

    hard: [
        { q: "d(P,R)=7, d(P,Q)=10, d(Q,R)=3. Middle?", o: ["P", "Q", "R", "None"], a: 2 },
        { q: "Distance between (x+3) and (x-3)?", o: ["2x", "x", "6", "3"], a: 2 },
        { q: "First step in Indirect Proof?", o: ["Assume True", "Assume False", "Antecedent", "Postulate"], a: 1 },
        { q: "Lines determined by 3 distinct points?", o: ["Only one", "Only three", "One or three", "Infinite"], a: 2 },
        { q: "Coord A=1. Points 7 units away?", o: ["8, -6", "6, -8", "7, -7", "1, 7"], a: 0 },
        { q: "Figure by 3 non-collinear points?", o: ["Line", "Segment", "Triangle", "Ray"], a: 2 },
        { q: "Collinear P-Q-R-S. PR=10, QS=10, PS=13. QR=?", o: ["3", "7", "10", "5"], a: 1 },
        { q: "Euclid: Lines intersect if angles sum...?", o: ["Exactly 180&deg;", "More than 180&deg;", "Less than 180&deg;", "Zero"], a: 2 }
    ]
};
