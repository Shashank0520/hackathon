...
const QUESTIONS = {
    easy: [
        { q: "Poet of the poem 'Life'?", o: ["H.W. Longfellow", "Charlotte Bront&euml;", "William Wordsworth", "Robert Frost"], a: 1 },
        { q: "Sages say life is NOT a?", o: ["Journey", "Dark dream", "Game", "Bright morning"], a: 1 },
        { q: "Little morning rain foretells?", o: ["Clouds", "Pleasant day", "Heavy storm", "Dark night"], a: 1 },
        { q: "Meaning of 'transient'?", o: ["Permanent", "Temporary", "Controlled", "Fearless"], a: 1 },
        { q: "Meaning of 'lament'?", o: ["To celebrate", "Express grief", "To ignore", "Rise upwards"], a: 1 },
        { q: "Life's sunny hours...?", o: ["Flit by", "Stay forever", "Slow moving", "Very dark"], a: 0 },
        { q: "Color of Hope's wings?", o: ["Silver", "Golden", "White", "Green"], a: 1 },
        { q: "Meaning of 'quell'?", o: ["To start", "End, suppress", "To encourage", "To shout"], a: 1 },
        { q: "'Life is a journey' is a?", o: ["Rhyme", "Metaphor", "Question", "Definition"], a: 1 },
        { q: "Meaning of 'buoyant'?", o: ["Sinking down", "Rise upwards", "Breaking apart", "Staying still"], a: 1 }
    ],

    medium: [
        { q: "Purpose of morning rain?", o: ["Cause gloom", "Bloom roses", "Stop play", "Hide sun"], a: 1 },
        { q: "How to enjoy sunny hours?", o: ["Gratefully, cheerily", "Sadly, slowly", "With fear", "By ignoring"], a: 0 },
        { q: "Who is 'our Best'?", o: ["Money", "Loved ones", "Dreams", "Clothes"], a: 1 },
        { q: "Which is a Negative Feeling?", o: ["Inspired", "Crushed", "Motivated", "Enthusiastic"], a: 1 },
        { q: "Hope bounces back because?", o: ["It is heavy", "Elastic springs", "It is dark", "It is still"], a: 1 },
        { q: "'Clouds of gloom' is metaphor for?", o: ["Bad weather", "Sadness", "Night time", "Rainy seasons"], a: 1 },
        { q: "If Hope falls, she remains?", o: ["Defeated", "Unconquered", "Dead", "Forgotten"], a: 1 },
        { q: "What can 'quell despair'?", o: ["Sorrow", "Courage", "Death", "Sages"], a: 1 },
        { q: "Synonym for 'Manfully'?", o: ["Cowardly", "Fearlessly", "Weakly", "Quietly"], a: 1 },
        { q: "'Calls our Best away' is?", o: ["Euphemism", "Alliteration", "Simile", "Repetition"], a: 0 }
    ],

    hard: [
        { q: "'What though death...?' is?", o: ["Metaphor", "Interrogation", "Acrostic", "Euphemism"], a: 1 },
        { q: "Figure of speech: 'Golden wings'?", o: ["Personification", "Onomatopoeia", "Hyperbole", "Irony"], a: 0 },
        { q: "'Elastic springs' implies Hope...?", o: ["Breaks", "Recovers quickly", "Disappears", "Stays down"], a: 1 },
        { q: "Gentle way to say unpleasant idea?", o: ["Metaphor", "Euphemism", "Personification", "Interrogation"], a: 1 },
        { q: "Figure of speech: 'Sunny hours'?", o: ["Metaphor", "Interrogation", "Acrostic", "Euphemism"], a: 0 },
        { q: "'Heavy sway' describes?", o: ["Rain", "Sorrow", "Roses", "Sunny hours"], a: 1 },
        { q: "Facing trial with strength?", o: ["Rapidly", "Manfully", "Transiently", "Cheerily"], a: 1 },
        { q: "Who is personified as 'buoyant'?", o: ["Death", "Hope", "Sorrow", "Life"], a: 1 }
    ]
};
