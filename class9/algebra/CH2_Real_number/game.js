...
const QUESTIONS = {
    easy: [
        { q: "Set {1, 2, 3...} is called?", o: ["Whole numbers", "Natural numbers", "Integers", "Rational numbers"], a: 1 },
        { q: "Symbol for Rational numbers?", o: ["N", "W", "I", "Q"], a: 3 },
        { q: "Property a + b = b + a?", o: ["Associative", "Commutative", "Identity", "Inverse"], a: 1 },
        { q: "Additive identity for number 'a'?", o: ["1", "0", "-a", "1/a"], a: 1 },
        { q: "Symbol &radic; is called?", o: ["Radical sign", "Order", "Radicand", "Index"], a: 0 },
        { q: "Value of |-3|?", o: ["-3", "3", "0", "1"], a: 1 },
        { q: "Surds of order 2 are called?", o: ["Cubic surds", "Quadratic surds", "Linear surds", "Perfect squares"], a: 1 },
        { q: "In &radic;[n]{a}, 'n' is called?", o: ["Radicand", "Order", "Power", "Factor"], a: 1 },
        { q: "Set {..., -3, -2, -1, 0, ...}?", o: ["I", "N", "W", "R"], a: 0 },
        { q: "Value of |0|?", o: ["1", "-1", "0", "Undefined"], a: 2 }
    ],

    medium: [
        { q: "Decimal of rational number is?", o: ["Non-terminating non-recurring", "Non-terminating recurring", "A surd", "Integer"], a: 1 },
        { q: "If prime factors are only 2 or 5?", o: ["Recurring", "Terminating", "Irrational", "Non-terminating"], a: 1 },
        { q: "Which is Irrational?", o: ["&radic;(16/25)", "&radic;5", "3/9", "&radic;196"], a: 1 },
        { q: "Conjugate of (&radic;a + &radic;b)?", o: ["(&radic;a + &radic;b)", "(&radic;a - &radic;b)", "(a - b)", "&radic;ab"], a: 1 },
        { q: "Product of conjugate binomial surds?", o: ["Irrational", "Rational number", "Surd", "Zero"], a: 1 },
        { q: "Like surds must have equal?", o: ["Signs", "Order & Radicand", "Prime factors", "Negative values"], a: 1 },
        { q: "To convert 2.513 (bar on 513)?", o: ["Multiply by 10", "Multiply by 100", "Multiply by 1000", "Multiply by 10000"], a: 2 },
        { q: "Simplest form of &radic;48?", o: ["16&radic;3", "4&radic;3", "3&radic;4", "2&radic;12"], a: 1 },
        { q: "Absolute value is never?", o: ["Zero", "Positive", "Negative", "Rational"], a: 2 },
        { q: "If ps &gt; qr, then?", o: ["p/q = r/s", "p/q &gt; r/s", "p/q &lt; r/s", "p+q &gt; r+s"], a: 1 }
    ],

    hard: [
        { q: "If x &lt; 0, then |x| is?", o: ["x", "-x", "0", "1/x"], a: 1 },
        { q: "Simplify: &radic;50 &times; &radic;18", o: ["&radic;68", "30", "15&radic;2", "900"], a: 1 },
        { q: "Compare 6&radic;2 and 5&radic;5?", o: ["6&radic;2 &gt; 5&radic;5", "6&radic;2 &lt; 5&radic;5", "Equal", "Undefined"], a: 1 },
        { q: "(&radic;5 + &radic;3)(&radic;5 - &radic;3)?", o: ["8", "2", "&radic;15", "15"], a: 1 },
        { q: "Solve: |x - 5| = 2", o: ["7 only", "3 only", "7 or 3", "-7 or -3"], a: 2 },
        { q: "0.666... in p/q form?", o: ["6/10", "2/3", "1/6", "66/100"], a: 1 },
        { q: "Rationalizing factor of &radic;27?", o: ["&radic;27", "&radic;3", "3", "9"], a: 1 },
        { q: "7&radic;3 + 29&radic;3 = ?", o: ["36&radic;6", "36&radic;3", "203", "36"], a: 1 }
    ]
};
