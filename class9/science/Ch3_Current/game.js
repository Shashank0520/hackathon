...
const QUESTIONS = {
    easy: [
        { q: "HTML stands for?", o: ["HyperText Markup Language", "HighText Machine Learning", "HyperTool Multi Link", "None"], a: 0 },
        { q: "CSS is used for?", o: ["Database", "Styling", "Logic", "Server"], a: 1 },
        { q: "3 + 5 = ?", o: ["6", "7", "8", "9"], a: 2 },
        { q: "Color of the sky?", o: ["Green", "Red", "Blue", "Yellow"], a: 2 },
        { q: "Capital of France?", o: ["Paris", "London", "Berlin", "Madrid"], a: 0 }
    ],
    medium: [
        { q: "JS Variable Keyword?", o: ["var", "int", "float", "dim"], a: 0 },
        { q: "Square root of 81?", o: ["7", "8", "9", "10"], a: 2 },
        { q: "Planet with rings?", o: ["Mars", "Venus", "Saturn", "Mercury"], a: 2 },
        { q: "H2O is?", o: ["Salt", "Water", "Gold", "Oxygen"], a: 1 },
        { q: "Largest Ocean?", o: ["Atlantic", "Indian", "Pacific", "Arctic"], a: 2 }
    ],
    hard: [
        { q: "Mitochondria is?", o: ["Brain", "Powerhouse", "Fluid", "Wall"], a: 1 },
        { q: "Value of Pi?", o: ["3.14", "3.16", "3.12", "3.41"], a: 0 },
        { q: "Speed of Light?", o: ["3x10^6", "3x10^8", "3x10^5", "3x10^9"], a: 1 },
        { q: "Atomic # of Carbon?", o: ["12", "6", "14", "8"], a: 1 },
        { q: "First person in space?", o: ["Armstrong", "Gagarin", "Aldrin", "Glenn"], a: 1 }
    ]
};
