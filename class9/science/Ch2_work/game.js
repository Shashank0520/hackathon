...
const QUESTIONS = {
    easy: [
        { q: "What is the SI unit of work?", o: ["Watt", "Joule", "Newton", "Erg"], a: 1 },
        { q: "What is the SI unit of power?", o: ["Joule", "Watt", "Newton-meter", "Horepower"], a: 1 },
        { q: "What is the basic formula for work?", o: ["Mass X Acceleration", "Force X Displacement", "Force / Time", "Mass X Velocity"], a: 0 },
        { q: "What is the CGS unit of work?", o: ["Joule", "Newton", "Dyne", "Erg"], a: 3 },
        { q: "Which form of energy is associated with motion?", o: ["Potential", "Kinetic", "Chemical", "Nuclear"], a: 1 },
        { q: "Which form of energy is associated with position?", o: ["Potential", "Kinectic", "Magnetic", "Sound"], a: 0 },
        { q: "What is the capacity to do work called?", o: ["Power", "Force", "Energy", "Momentum"], a: 2 },
        { q: "What happens to the total energy in free fall?", o: ["Increases", "Decreases", "Constant", "Becomes Zero"], a: 2 },
        { q: "What is another name for Joule per second (J/s)?", o: ["Newton", "Pascal", "Watt", "Erg"], a: 2 },
        { q: "What is the formula for Kinetic energy?", o: ["mgh", "&frac12; mv<sup>2</sup>", "mv", "ma"], a: 1 },
    ],
    medium: [
        { 
            q: "Output energy type of a microphone?", 
            o: ["Sound", "Electrical", "Chemical", "Heat"], 
            a: 1 
        },
        { 
            q: "Work done while stopping a car?", 
            o: ["Positive", "Negative", "Zero", "Stationary"], 
            a: 1 
        },
        { 
            q: "City where NPL HQ is located?", 
            o: ["Mumbai", "New Delhi", "Bangalore", "Kolkata"], 
            a: 1 
        },
        { 
            q: "If mass doubles, K.E. ...?", 
            o: ["Halves", "Doubles", "Quadruples", "Stays same"], 
            a: 1 
        },
        { 
            q: "Rate of doing work is?", 
            o: ["Energy", "Force", "Power", "Acceleration"], 
            a: 2 
        },
        { 
            q: "Energy in a stretched bow?", 
            o: ["Potential", "Kinetic", "Electrical", "Thermal"], 
            a: 0 
        },
        { 
            q: "Output of an electric lamp?", 
            o: ["Chemical", "Light", "Sound", "Nuclear"], 
            a: 1 
        },
        { 
            q: "Is it possible to destroy energy?", 
            o: ["Yes", "No", "Only in space", "Only via friction"], 
            a: 1 
        }
    ],
    hard: [
        { 
            q: "Rebound height (10m drop, 40% loss)?", 
            o: ["4 meters", "6 meters", "5 meters", "8 meters"], 
            a: 1 
        },
        { 
            q: "Is Potential Energy...?", 
            o: ["Absolute", "Relative", "Constant", "None"], 
            a: 1 
        },
        { 
            q: "Law of Energy states?", 
            o: ["Conservation", "Creation", "Destruction", "Graduation"], 
            a: 0 
        },
        { 
            q: "K.E. if Momentum is Zero?", 
            o: ["Zero", "Maximum", "1 J", "Negative"], 
            a: 0 
        },
        { 
            q: "Work done if displacement is 0?", 
            o: ["Zero", "Maximum", "Infinite", "Undefined"], 
            a: 0 
        },
        { 
            q: "Total energy in free-fall?", 
            o: ["Zero", "&frac12; mv<sup>2</sup>", "mgh", "v<sup>2</sup>"], 
            a: 2 
        },
        { 
            q: "K.E. of 250g object at 2m/s?", 
            o: ["1 J", "0.5 J", "2 J", "0.25 J"], 
            a: 1 
        },
        { 
            q: "Work for 10N force & 30cm dist?", 
            o: ["300 J", "30 J", "3 Joules", "0.3 J"], 
            a: 2 
        }
    ]
};
